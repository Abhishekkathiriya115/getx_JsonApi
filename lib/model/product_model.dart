...
//
// String productJson(List<ProductModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
//
// class ProductModel {
//   ProductModel({
//     this.id,
...
class ProductModel {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
    ...
    image: json["image"],
    author: json["author"],
    postDate: postDateValues.map[json["post_date"]],
    titlle: json["titlle"],
    body: json["body"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "image": image,
    "author": author,
    "post_date": postDateValues.reverse[postDate],
    "titlle": titlle,
    "body": body,
